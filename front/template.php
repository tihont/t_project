<?php
/**
 * Главный шаблон сайта. Выводит шапку (header), основной контент в средней секции сайта и футер. Подключает статические
 * ресурсы (js, css) и подшаблоны, в зависимости от запрошенной страницы.
 */
?>
<!DOCTYPE html>
<html lang="en">
